...
- [x] **1. Confirm isolation and scaffold the app**
...
- [x] **2. Build the warm responsive shell**
...
- [ ] **3. Implement in-page camera capture**
...
- [x] **4. Implement voice recording and AI draft**
...
- [ ] **5. Add HomeRelay-only Supabase schema and RLS**
...
- [ ] **6. Save confirmed handoffs and update in realtime**
...
- [ ] **7. Implement action and needed-item states**
...
- [ ] **8. Integrate Qdrant meaningfully**
...
- [ ] **9. Harden privacy, errors, and accessibility**
...
- [ ] **10. Run the winning demo twice and prepare handoff**
